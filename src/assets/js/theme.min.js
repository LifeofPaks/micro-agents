    ...
    for (
      ...
      if (n[o].href === t) {
        if (
          ...
          n[o].classList.contains("dropdown-item"))
        ) {
          const e = n[o].closest(".dropdown");
          if (e) {
            const t = e.querySelector(".nav-link.dropdown-toggle");
            t && t.classList.add("active");
          }
        }
        localStorage.setItem("activeLink", n[o].href);
      }
    var a = localStorage.getItem("activeLink");
    if (a)
